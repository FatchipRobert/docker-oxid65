...
$this->dbCharset = 'utf8';
$this->dbHost = 'mysql.localhost'; // database host name
$this->dbPort  = 3306; // tcp port to which the database is bound
$this->dbName = 'docker'; // database name
$this->dbUser = 'docker'; // database user name
$this->dbPwd  = 'docker'; // database user password
